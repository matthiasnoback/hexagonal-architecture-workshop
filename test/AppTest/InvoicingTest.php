...
final class InvoicingTest extends AbstractBrowserTest
{
    public function testCreateInvoice(): void
    {
        ...
        $this->scheduleMeetup('Meetup 1', 'Description', '2022-02-10', '20:00');
        $this->scheduleMeetup('Meetup 2', 'Description', '2022-02-17', '20:00');
        $this->logout();
        ...
        $this->listOrganizersPage()
            ...
            ->createInvoice($this->browser, '2022', '2');
        $this->flashMessagesShouldContain('Invoice created');

        $invoicesPage = $this->listOrganizersPage()
            ->firstOrganizer()
            ->listInvoices($this->browser);
        self::assertEquals('10.00', $invoicesPage->invoiceAmountForPeriod('2/2022'));
    }

    public function testCreate2InvoicesCancelOne(): void
    {
        $this->signUp('Organizer', 'organizer@gmail.com', 'Organizer');
        $this->signUp('Administrator', 'administrator@gmail.com', 'Administrator');

        $this->login('organizer@gmail.com');
        $this->scheduleMeetup('Meetup accepted', 'Description', '2022-10-10', '20:00');
        $this->scheduleMeetup('Meetup cancelled', 'Description', '2022-10-17', '20:00');
        $this->cancelMeetup('Meetup cancelled');
        $this->logout();
        ...
        $invoicesPage = $this->listOrganizersPage()
            ->firstOrganizer()
            ->listInvoices($this->browser);
        self::assertEquals('5.00', $invoicesPage->invoiceAmountForPeriod('10/2022'));
    }
