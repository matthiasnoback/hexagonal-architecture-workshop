...
final class InvoicingTest extends AbstractBrowserTest
{
    public function testCreateInvoice(): void
    {
        ...
        $this->scheduleMeetup('Meetup 1', 'Description', '2023-01-10', '20:00');
        $this->scheduleMeetup('Meetup 2', 'Description', '2023-01-17', '20:00');
        $this->logout();
