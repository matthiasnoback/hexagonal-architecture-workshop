...
final class InvoicingTest extends AbstractBrowserTest
{
    public function testCreateInvoice(): void
    {
        ...
        $this->scheduleMeetup('Meetup 1', 'Description', '2022-11-10', '20:00');
        $this->scheduleMeetup('Meetup 2', 'Description', '2022-11-17', '20:00');
        $this->logout();
